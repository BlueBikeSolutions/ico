...
contract Crowdsale is CrowdsaleBase {
  ...
  function Crowdsale(address _token, PricingStrategy _pricingStrategy, address[] _multisigWallets, uint _start, uint _end, uint _minimumFundingGoal) CrowdsaleBase(_token, _pricingStrategy, _multisigWallets, _start, _end, _minimumFundingGoal) {
  }
